    ...
    <div class="hentry hentry-post blog-big group ">
        ...
        <div class="thumbnail">
            ...
            <div class="image-wrap">
                <img src="{{ asset(config('settings.theme')) }}/images/articles/{{ $article->image->max }}" alt="00212" title="00212" />
            </div>
            <p class="date">
        ...
        <div class="meta group">
            ...
            <p class="categories"><span>In: <a href="{{ route('articlesCategory', ['category_alias' => $article->category->alias]) }}" title="View all posts in {{ $article->category->title }}" rel="category tag">{{ $article->category->title }}</a></span></p>
    ...
    <div id="comments">
        ...
        <ol class="commentlist group">
            ...
            @foreach($com as $k => $comment)
                ...
                @include(config('settings.theme').'.comment', ['items' => $comment])
            @endforeach
